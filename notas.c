...
/* 
    ...
    Cada alumno solo debe aparecer una vez en el array. Si un alumno tiene varias notas (su nombre se repite en la lista)
    se deben guardar todas las notas en el array notas.
